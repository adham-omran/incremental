...
public class UIBuilder {
     ...
     */
    public static VBox buildContentActionsSection(EventHandler<ActionEvent> clipboardHandler, EventHandler<ActionEvent> pdfHandler) {
     ...
     */
    public static VBox buildNavigationSection(EventHandler<ActionEvent> nextHandler, EventHandler<ActionEvent> tableHandler) {
     ...
     */
    public static VBox buildTopicControlsSection(EventHandler<ActionEvent> nextHandler, EventHandler<ActionEvent> closeHandler) {
     ...
     */
    public static VBox buildPageNavigationSection(EventHandler<ActionEvent> prevHandler, EventHandler<ActionEvent> nextHandler,
        ...
        Button btnJumpToPage = UIComponentFactory.createButton("Go", "compact-tertiary-button", "Jump to the specified page", jumpHandler);
     ...
     */
    public static VBox buildViewControlsSection(EventHandler<ActionEvent> fitPageHandler, EventHandler<ActionEvent> fitWidthHandler,
        ...
        Button btnFitToPage = UIComponentFactory.createButton("Fit Page", "compact-tertiary-button", null, fitPageHandler);
        Button btnFitToWidth = UIComponentFactory.createButton("Fit Width", "compact-tertiary-button", null, fitWidthHandler);
        ...
        Button btnZoomOut = UIComponentFactory.createButton("➖", "compact-secondary-button", "Zoom out (Ctrl + -)", zoomOutHandler);
        Button btnZoomIn = UIComponentFactory.createButton("➕", "compact-secondary-button", "Zoom in (Ctrl + +)", zoomInHandler);
        Button btnZoomReset = UIComponentFactory.createButton("Reset", "compact-tertiary-button", "Reset zoom to 100%", resetHandler);
     ...
     */
    public static VBox buildDrawingSection(EventHandler<ActionEvent> drawModeHandler, EventHandler<ActionEvent> clearHandler) {
        ...
        Button btnDrawMode = UIComponentFactory.createButton("Draw Mode", "compact-tertiary-button", "Toggle drawing mode to draw rectangles", drawModeHandler);
        Button btnClearRects = UIComponentFactory.createButton("Clear", "compact-secondary-button", "Clear all rectangles on this page", clearHandler);
